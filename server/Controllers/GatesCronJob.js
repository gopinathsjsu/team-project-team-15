...
export function StartCronGates(upcomflight, flights){  
    ...
    const initcheck = async() => {
        const gatedetails = await axios.get(`http://localhost:5001/api/v1/gates/${upcomflight}`);
        console.log(gatedetails.data);
        if (gatedetails.data === null){
